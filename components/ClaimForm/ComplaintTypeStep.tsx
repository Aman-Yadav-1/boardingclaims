...
export const ComplaintTypeStep: React.FC<StepProps> = ({ formData, setFormData, setCurrentStep }) => {
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          {formData.errors?.complaintType && (
            <p className="text-red-500 text-sm mt-1">{formData.errors.complaintType}</p>
          )}
        </div>
