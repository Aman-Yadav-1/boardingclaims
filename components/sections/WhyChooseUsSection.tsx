        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Only pay when we win your case</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Fast claim processing within 72 hours</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Dedicated specialists in flight claims</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Over 95% success rate in claims</p>
            </div>
          </div>
        </div>
      </section>
